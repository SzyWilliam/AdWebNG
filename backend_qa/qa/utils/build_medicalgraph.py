...
class MedicalGraph:
    def __init__(self):
        ...
        self.g = Graph("http://44.193.100.172:7474", auth=("neo4j", "000720"))
    ...
    def read_nodes(self):
        ...
        for data in open(self.data_path, encoding='UTF-8'):
            ...
            if 'recommend_drug' in data_json:
                recommend_drug = data_json['recommend_drug']
                drugs += recommend_drug
                for drug in recommend_drug:
                    rels_recommenddrug.append([disease, drug])
            ...
            if 'not_eat' in data_json:
                ...
                foods += do_eat
                recommend_eat = data_json['recommend_eat']

                for _recommend in recommend_eat:
                    rels_recommendeat.append([disease, _recommend])
                foods += recommend_eat
        ...
        return set(drugs), set(foods), set(checks), set(departments), set(producers), set(symptoms), set(
            diseases), disease_infos, \
               rels_check, rels_recommendeat, rels_noteat, rels_doeat, rels_department, rels_commondrug, rels_drug_producer, rels_recommenddrug, \
               rels_symptom, rels_accompany, rels_category
    ...
    def create_graphnodes(self):
        Drugs, Foods, Checks, Departments, Producers, Symptoms, Diseases, disease_infos, rels_check, rels_recommendeat, rels_noteat, rels_doeat, rels_department, rels_commonddrug, rels_drug_producer, rels_recommenddrug, rels_symptom, rels_accompany, rels_category = self.read_nodes()
    ...
    def create_graphrels(self):
        Drugs, Foods, Checks, Departments, Producers, Symptoms, Diseases, disease_infos, rels_check, rels_recommendeat, rels_noteat, rels_doeat, rels_department, rels_commonddrug, rels_drug_producer, rels_recommenddrug, rels_symptom, rels_accompany, rels_category = self.read_nodes()
        self.create_relationship('Disease', 'Food', rels_recommendeat, 'recommend_eat', '推荐食谱')
